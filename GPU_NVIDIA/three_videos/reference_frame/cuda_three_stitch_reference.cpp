...
int main(int argc, char const *argv[]) {
  ...
  /* cv::VideoCapture cap3("./markerVid/right.mp4"); */
  ...
  while (running) {
    ...
    /* cv::imshow("Frame2", displayKeypoints(Frame2, kp2)); */
    /* cv::imshow("Frame1", displayKeypoints(Frame1, kp1)); */
    /* cv::imshow("Frame3", displayKeypoints(Frame3, kp3)); */
    ...
    cv::Mat drawMatches; 
    cv::Mat drawMatches1; 
    cv::drawMatches(Frame2, kp2, Frame1, kp1, match1, drawMatches);
    cv::drawMatches(Frame2, kp2, Frame3, kp3, match2, drawMatches1);
    cv::imshow("matche1", drawMatches);
    cv::imshow("matche2", drawMatches1);
